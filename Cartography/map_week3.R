...
#boroughs$Borough <- as.character(boroughs$Borough)

str(boroughs)
# Making a scatter plot 
(b_plot <- ggplot(boroughs, aes(x = Borough, y = open_space, colour = Borough)) + 
    geom_point())
...
boroughs_os_sp <- data.frame(City = c(100, 0, 18.6),
                          Barking = c(100, 0, 33.7), 
                          Barnet = c(100, 0, 37.7), 
                          Bexley = c(100, 0, 38.9), 
                          Brent = c(100, 0, 22.3), 
                          Bromley = c(100, 0, 57.4), 
                          Camden = c(100, 0, 24.6), 
                          Croydon = c(100, 0, 32.2), 
                          Ealing = c(100, 0, 31.5), 
                          Enfield = c(100, 0, 48.5), 
                          Greenwich = c(100, 0, 39.3), 
                          Hackney = c(100, 0, 28.3), 
                          Hammersmith = c(100, 0, 21.1), 
                          Haringey = c(100, 0, 27.8), 
                          Harrow = c(100, 0, 32.1), 
                          Havering = c(100, 0, 59.0), 
                          Hillingdon = c(100, 0, 45.0),
                          Hounslow = c(100, 0, 37.5), 
                          Islington = c(100, 0, 13.7), 
                          Kensington = c(100, 0, 19.8),
                          Kingston = c(100, 0, 36.9), 
                          Lambeth = c(100, 0, 20.7), 
                          Lewisham = c(100, 0, 22.1), 
                          Merton = c(100, 0, 35.9), 
                          Newham = c(100, 0, 29.9), 
                          Redbridge = c(100, 0, 40.3), 
                          Richmond = c(100, 0, 57.0), 
                          Southwark = c(100, 0, 22.6), 
                          Sutton = c(100, 0, 33.9), 
                          Tower_Hamlets = c(100, 0, 26.9), 
                          Waltham_Forest = c(100, 0, 34.8), 
                          Wandsworth = c(100, 0, 31.6), 
                          Westminster = c(100, 0, 28.6))
...
(plt <- ggplot(boroughs_os, aes(x=Borough, y=open_space, fill = Borough)) + 
